...
layout(location = 0) in flat vec2 material;
layout(location = 1) in vec3 pos_rel_cam;
layout(location = 2) in vec3 normal_rel_cam;
layout(location = 3) in vec2 cell_uv;
layout(location = 4) in vec4 pos_on_shadow_map;
